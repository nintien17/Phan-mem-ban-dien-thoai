...
namespace Phanmembandienthoai
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename='C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Quanlibandienthoai.mdf';Integrated Security=True;Connect Timeout=30";
            con.Open();
